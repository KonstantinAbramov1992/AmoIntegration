...
// Тело запроса
$body = json_encode([
    'conversation_id'=> '77015409019-1629873669',
    'user'=> [
    'id'=> '9204111',
...
curl_setopt_array($curl, array(
    CURLOPT_URL => "https://amojo.amocrm.ru/api/v2/origin/custom/$scope_id/chats",
...
if ($err) {
    ...
    var_dump($response);
    var_dump(curl_getinfo($curl)['http_code']);
    file_put_contents('response2.json', $response);
}
curl_close($curl);
